 ...
 match
   ...
   return
     ((fun i0irr_R0 : I_R i i₂ =>
       forall i1irr_R0 : B_R i i₂ i0irr_R0 b b₂,
       Top_multIndices2_multInd_pmtcty_RR0_indices A A₂ A_R I I₂ I_R B B₂ B_R
         f f₂ f_R g g₂ g_R i i₂ i_R b b₂ b_R (*i_R*) i0irr_R0 i1irr_R0) trEqr)
 with
 | eq_refl =>
       ...
       return
         ((fun i1irr_R : B_R i i₂ i_R b b₂ =>
           Top_multIndices2_multInd_pmtcty_RR0_indices A A₂ A_R I I₂ I_R B B₂
             B_R f f₂ f_R g g₂ g_R i i₂ i_R b b₂ b_R i_R (*b_R *) i1irr_R) trEqr)
     with
     | eq_refl =>
