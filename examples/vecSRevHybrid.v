...
| vnil : Vec C 0 
| vcons : forall n : nat, C -> Vec C n -> Vec C (n+1).
...
Inductive Vec_cons_RR  (C₁ C₂ : Set) (C_R : C₁ -> C₂ -> Prop) 
(Vec_RR: forall H H0 : nat, nat_RR H H0 -> Vec C₁ H -> Vec C₂ H0 -> Set)
(n₁ n₂ : nat)
(H : C₁) (H0 : C₂)
(H1 : Vec C₁ n₁) (H2 : Vec C₂ n₂) : nat_RR (n₁ +1) (n₂+1) -> Prop :=
| Vec_cons_RR_cc: forall (cr:C_R H H0) (n_R : nat_RR n₁ n₂),
                    Vec_RR n₁ n₂ n_R H1 H2 ->
       Vec_cons_RR C₁ C₂ C_R Vec_RR n₁ n₂ H H0 H1 H2
        (Coq_Init_Nat_add_RR n₁ n₂ n_R 1 1 (S_RR 0 0 O_RR)).
...
(fix
 ReflParam_matchR_Vec_RR0 (C C₂ : Set) (C_R : C -> C₂ -> Prop) (H H0 : nat)
   ...
   | vcons _ n x x0 =>
       ...
       | vcons _ n₂ x1 x2 =>
       fun nr =>
       Vec_cons_RR C C₂ C_R (ReflParam_matchR_Vec_RR0 C C₂ C_R) n n₂ x x1 x0 x2 nr
       end
   end) H1
    ).
