...
Notation Vec_RR := Vec_R.
Notation vnil_RR := Vec_R_vnil_R.
Notation vcons_RR := Vec_R_vcons_R.
Notation add_RR := Coq_o_Init_o_Nat_o_add_R.
Definition one_RR : nat_R 1 1.
  constructor. constructor.
Defined. 

Notation O_RR := common.nat_R_O_R.
Notation S_RR := nat_R_S_R.

Require Import SquiggleEq.tactics.
Require Import SquiggleEq.LibTactics.
Notation nat_RR := common.nat_R.
...
Proof.
  ...
  destruct v₁;
   destruct v₂; intros.
  - simpl. clear f₁0 f₂0 f0_R.
    Fail induction v_R.
    (* this is hard to prove, but possible to prove, because there is an isomorphism
      between Vec_R and Vec_RDed. so one can apply that isomorphism to v_R to get
      that n_R is 0_RR *)
    
    inverts v_R.
   simpl in v_R. unfold vnil_RR in f_R. simpl in f_R.
    subst. assumption. 
